...
*	user 用户名，字符串
*	pass 密码，字符串
*	servers 主机，格式：	host:port:weight
*/
"memcache"	=>	array (
	'is_use'=>0,
	'use_memcached'=>1,
	...
	'pass'=>null,
	"servers"=>array (
		'192.168.1.167:11211:100',
		'192.168.1.183:11211:100'
	)
),
...
"redis"	=>	array (
	...
	"time_out"=>0 ,
	"servers"=>array (
		"rUser"			=>'127.0.0.1:6379:0',
		"rVirtue"		=>'127.0.0.1:6379:1',
		"rIpLimits"		=>'127.0.0.1:6379:2'
	)
),
...
"site" => array( 
	"admin"		=> "http://gonghui.netkingol.com",
),
